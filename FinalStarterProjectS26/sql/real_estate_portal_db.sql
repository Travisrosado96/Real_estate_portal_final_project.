...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2026 at 02:39 AM
...
--
-- Stand-in structure for view `propertylistview`
-- (See below for the actual view)
--
CREATE TABLE `propertylistview` (
`propertyId` int(11)
,`title` varchar(100)
